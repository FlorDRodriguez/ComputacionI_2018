...
bool UsuarioDAO::exist(Usuario* Usuario)
{
    ...
    stringSQL = "SELECT * FROM Usuario WHERE id = " + ss.str();
...
void UsuarioDAO::update(Usuario* Usuario)
{
    ...
    stringSQL = "UPDATE Usuario SET usuario = '" + Usuario->getUsuario() + "' WHERE id = " + ss.str();
    MyConnection::instance()->execute(stringSQL);
}
...
void UsuarioDAO::add(Usuario* Usuario)
{
    ...
    stringSQL = "INSERT INTO Usuario (id, usuario) VALUES (" + ss.str() + ", '" + Usuario->getUsuario() + "')";
    MyConnection::instance()->execute(stringSQL);
}
